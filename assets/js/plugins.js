...
!(function (t) {
  ...
  (h.cleanData =
    ...
    (h.widget = function (t, i, e) {
      ...
      return (
        ...
        ((a = new i()).options = h.widget.extend({}, a.options)),
    ...
    (h.Widget.prototype = {
      ...
      option: function (t, e) {
        ...
        if ("string" == typeof t)
          if (((a = {}), (t = (i = t.split(".")).shift()), i.length)) {
            for (
              s = a[t] = h.widget.extend({}, this.options[t]), n = 0;
              n < i.length - 1;
              n++
            )
              (s[i[n]] = s[i[n]] || {}), (s = s[i[n]]);
      ...
      _classes: function (n) {
        ...
        function t(t, e) {
          for (var i, s = 0; s < t.length; s++)
            (i = o.classesElementLookup[t[s]] || h()),
              (i = n.add
      ...
      _on: function (n, a, t) {
        ...
        "boolean" != typeof n && ((t = a), (a = n), (n = !1)),
          t
            ? ((a = o = h(a)), (this.bindings = this.bindings.add(a)))
    ...
    h.each({ show: "fadeIn", hide: "fadeOut" }, function (a, o) {
  ...
  h.widget,
    ...
    (h.ui.ie = !!/msie [\w.]+/.exec(navigator.userAgent.toLowerCase()));
  var a = !1;
    ...
    _mouseInit: function () {
      ...
      this.element
        ...
        .on("click." + this.widgetName, function (t) {
          if (!0 === h.data(t.target, e.widgetName + ".preventClickEvent"))
            return (
              h.removeData(t.target, e.widgetName + ".preventClickEvent"),
      ...
      if (!a) {
        ...
        var e = this,
          ...
          s =
            ...
            h(t.target).closest(this.options.cancel).length;
        return i && !s && this._mouseCapture(t)
          ? ((this.mouseDelayMet = !this.options.delay),
            ...
            !this._mouseStarted)
              ? (t.preventDefault(), !0)
              : (!0 ===
                  h.data(t.target, this.widgetName + ".preventClickEvent") &&
                  h.removeData(
                    t.target,
      ...
      this.document
        ...
        this._mouseStarted &&
          ...
          t.target === this._mouseDownEvent.target &&
            h.data(t.target, this.widgetName + ".preventClickEvent", !0),
          this._mouseStop(t)),
    ...
    h.widget("ui.slider", h.ui.mouse, {
      ...
      _createHandles: function () {
        ...
        for (
          ...
          s.push(
            "<span tabindex='0' role='button' aria-label='Slide Control Handle' title='Control deslizante'></span>"
          );
        (this.handles = i.add(h(s.join("")).appendTo(this.element))),
          this._addClass(this.handles, "ui-slider-handle", "ui-state-default"),
          (this.handle = this.handles.eq(0)),
          this.handles.each(function (t) {
            h(this).data("ui-slider-handle-index", t).attr("tabIndex", 0);
          });
      },
          ...
          ? (!0 === t.range &&
              (t.values
                ? t.values.length && 2 !== t.values.length
                  ...
                  : h.isArray(t.values) && (t.values = t.values.slice(0))
            ...
            this.range && this.range.length
              ...
              : ((this.range = h("<div>").appendTo(this.element)),
      ...
      _mouseCapture: function (t) {
        ...
        return (
          ...
          !1 !== this._start(t, a) &&
            ...
            n.trigger("focus"),
            (e = n.offset()),
            (o = !h(t.target).parents().addBack().is(".ui-slider-handle")),
            (this._clickOffset = o
              ? { left: 0, top: 0 }
              : {
          ...
          ("range" === t &&
            ...
            ("min" === e
              ...
              : "max" === e &&
                ...
                (this.options.values = null))),
          h.isArray(this.options.values) && (s = this.options.values.length),
          this._super(t, e),
          t)
        ) {
          case "orientation":
        ...
        this._hasMultipleValues()
          ? this.handles.each(function (t) {
              (i =
                ...
                100),
                (u["horizontal" === r.orientation ? "left" : "bottom"] =
                  i + "%"),
                h(this).stop(1, 1)[l ? "animate" : "css"](u, o.animate),
                !0 === r.options.range &&
          ...
          : ((t = this.value()),
            ...
            "max" === a &&
              ...
              this.range
                .stop(1, 1)
                [l ? "animate" : "css"]({ width: 100 - i + "%" }, o.animate),
            "min" === a &&
            ...
            "max" === a &&
              ...
              this.range
                .stop(1, 1)
                [l ? "animate" : "css"]({ height: 100 - i + "%" }, o.animate));
      },
      _handleEvents: {
        keydown: function (t) {
          var e,
          ...
          switch (t.keyCode) {
            ...
            case h.ui.keyCode.LEFT:
              if (
                ...
                !this._keySliding &&
                  ((this._keySliding = !0),
                  this._addClass(h(t.target), null, "ui-state-active"),
                  !1 === this._start(t, n)))
              )
                return;
          }
        ...
        keyup: function (t) {
          ...
          this._keySliding &&
            ...
            this._stop(t, e),
            this._change(t, e),
            this._removeClass(h(t.target), null, "ui-state-active"));
        },
      },
    });
  var c,
  ...
  function A(s) {
    ...
    return (
      ...
      a.length
        ? ("0,0,0,0" === a.join() && c.extend(a, l.transparent), n)
        : l[s]
    );
  }
  function T(t, e, i) {
  ...
  function V(t) {
    ...
    if (s && s.length && s[0] && s[s[0]])
      for (i = s.length; i--; )
        "string" == typeof s[(e = s[i])] && (n[h.camelCase(e)] = s[e]);
    else for (e in s) "string" == typeof s[e] && (n[e] = s[e]);
    return n;
  }
  function P(t, e, i, s) {
    return (
      h.isPlainObject(t) && (t = (e = t).effect),
      (t = { effect: t }),
      null == e && (e = {}),
  ...
  function W(t) {
    return (
      ...
      "number" == typeof t ||
      h.fx.speeds[t] ||
      ("string" == typeof t && !h.effects.effect[t]) ||
      h.isFunction(t) ||
  ...
  (h.effects = { effect: {} }),
    ...
    (p.fn = c.extend(p.prototype, {
      parse: function (n, t, e, i) {
        ...
        (n.jquery || n.nodeType) && ((n = c(n).css(t)), (t = f));
        var a = this,
          s = c.type(n),
          o = (this._rgba = []);
        return (
                ...
                n instanceof p
                  ...
                  : function (t, i) {
                      ...
                      v(i.props, function (t, e) {
                        ...
                        a[s] &&
                          c.inArray(null, a[s].slice(0, 3)) < 0 &&
                          ((a[s][3] = 1), i.from && (a._rgba = i.from(a[s])));
                    }
              ),
              this)
            : void 0
    ...
    v(g, function (l, t) {
      var a = t.props,
        ...
        u = t.from;
      (p.fn[l] = function (t) {
        if ((r && !this[o] && (this[o] = r(this._rgba)), t === f))
          return this[o].slice();
        var e,
          i = c.type(t),
    ...
    h.fn.addBack ||
      (h.fn.addBack = function (t) {
        return this.add(
          null == t ? this.prevObject : this.prevObject.filter(t)
        );
      }),
    (h.effects.animateClass = function (n, t, e, i) {
      var a = h.speed(t, e, i);
      return this.queue(function () {
        var i = h(this),
          t = i.attr("class") || "",
          e = (e = a.children ? i.find("*").addBack() : i).map(function () {
            return { el: h(this), start: V(this) };
          }),
          s = function () {
            h.each(b, function (t, e) {
              n[e] && i[e + "Class"](n[e]);
            });
          };
        s(),
              ...
              (this.diff = (function (t, e) {
                ...
                for (i in e)
                  (s = e[i]),
                    t[i] !== s &&
                      (x[i] ||
                        (!h.fx.step[i] && isNaN(parseFloat(s))) ||
                        (n[i] = s));
                return n;
              })(this.start, this.end)),
              this
          ...
          h.when.apply(h, e.get()).done(function () {
            s(),
              h.each(arguments, function () {
                var e = this.el;
                h.each(this.diff, function (t) {
                  e.css(t, "");
                });
              }),
              a.complete.call(i[0]);
    ...
    h.fn.extend({
      addClass:
        ...
        function (t, e, i, s) {
          return e
            ? h.effects.animateClass.call(this, { add: t }, e, i, s)
      ...
      removeClass:
        ...
        function (t, e, i, s) {
          return 1 < arguments.length
            ? h.effects.animateClass.call(this, { remove: t }, e, i, s)
      ...
      toggleClass:
        ...
        function (t, e, i, s, n) {
          return "boolean" == typeof e || void 0 === e
            ...
            : h.effects.animateClass.call(this, { toggle: t }, e, i, s);
        }),
      switchClass: function (t, e, i, s, n) {
        return h.effects.animateClass.call(
          this,
          { add: e, remove: t },
          i,
          s,
    ...
    h.expr &&
      h.expr.filters &&
      h.expr.filters.animated &&
      (h.expr.filters.animated =
        ((s = h.expr.filters.animated),
        function (t) {
          return !!h(t).data(O) || s(t);
        })),
    !1 !== h.uiBackCompat &&
      h.extend(h.effects, {
        save: function (t, e) {
        ...
        createWrapper: function (i) {
          ...
          return (
            i.wrap(t),
            (i[0] !== n && !h.contains(i[0], n)) || h(n).trigger("focus"),
            (t = i.parent()),
        ...
        removeWrapper: function (t) {
          ...
          return (
            t.parent().is(".ui-effects-wrapper") &&
              ...
              (t[0] !== e && !h.contains(t[0], e)) || h(e).trigger("focus")),
            t
          );
        },
      }),
    h.extend(h.effects, {
      ...
      define: function (t, e, i) {
        return (
          i || ((i = e), (e = "effect")),
          (h.effects.effect[t] = i),
          (h.effects.effect[t].mode = e),
          i
        );
      },
      ...
      cleanUp: function (t) {
        h.effects.restoreStyle(t), h.effects.removePlaceholder(t);
      },
    ...
    h.fn.extend({
      effect: function () {
        function t(t) {
          var e = h(this),
            i = h.effects.mode(e, r) || a;
          e.data(O, !0),
            l.push(i),
            a && ("show" === i || (i === a && "hide" === i)) && e.show(),
            (a && "none" === i) || h.effects.saveStyle(e),
            h.isFunction(t) && t();
        }
        var s = P.apply(this, arguments),
          n = h.effects.effect[s.effect],
          a = n.mode,
          e = s.queue,
          i = e || "fx",
          o = s.complete,
        ...
        function u(t) {
          var e = h(this);
          function i() {
            h.isFunction(o) && o.call(e[0]), h.isFunction(t) && t();
          }
          (s.mode = l.shift()),
            !1 === h.uiBackCompat || a
              ? "none" === s.mode
      ...
      transfer: function (t, e) {
        var i = h(this),
          ...
          s = i.offset(),
          l = h("<div class='ui-effects-transfer'></div>")
            .appendTo("body")
            ...
            .animate(a, t.duration, t.easing, function () {
              l.remove(), h.isFunction(e) && e();
            });
      },
    }),
    (h.fx.step.clip = function (t) {
      t.clipInit ||
        ((t.start = h(t.elem).cssClip()),
    ...
    (k = {}),
    h.each(["Quad", "Cubic", "Quart", "Quint", "Expo"], function (e, t) {
      k[t] = function (t) {
    ...
    h.each(k, function (t, e) {
      (h.easing["easeIn" + t] = e),
        (h.easing["easeOut" + t] = function (t) {
          return 1 - e(1 - t);
        }),
        (h.easing["easeInOut" + t] = function (t) {
...
(function ($) {
  $.fn.timer = function (settings, callback) {
    if (this.data("timer") && this.data("timer").exists) return !1;
    var defaults = {
      autostart: !1,
      direction: "cw",
      format: "{h}:{m}:{s}",
    ...
    timer.debug = { index: "#" + timer.target.attr("id") };
    ...
    timer.formate = function (sec) {
      ...
      if (format.indexOf("{s}") >= 0) {
        var s = Math.floor(parseInt(sec));
        if (s < 10) s = "0" + s;
      }
      if (format.indexOf("{m}") >= 0) {
        var s = Math.floor(parseInt(sec % 60));
        if (s < 10) s = "0" + s;
        var m = Math.floor(parseInt(sec / 60));
        if (m < 10) m = "0" + m;
      }
      if (format.indexOf("{h}") >= 0) {
        var s = Math.floor(parseInt(sec % 60));
        if (s < 10) s = "0" + s;
        var m = Math.floor(parseInt((sec / 60) % 60));
        if (m < 10) m = "0" + m;
        var h = Math.floor(parseInt(sec / 60 / 60));
        if (h < 10) h = "0" + h;
      }
      if (format.indexOf("{d}") >= 0) {
        ...
        var m = Math.floor(parseInt((sec / 60) % 60));
        if (m < 10) m = "0" + m;
        var h = Math.floor(parseInt(sec / 60 / 60) % 24);
        if (h < 10) h = "0" + h;
    ...
    timer.increase = function () {
      ...
      if (typeof timer.options.onChange === "function") {
        timer.options.onChange(timer.formate(timer.currentVal));
      }
    };
      ...
      ? (function () {
          ...
          var e = function (a, b) {
            (this._bIsPainted = !1),
              ...
              this._elImage.setAttribute("alt", "QR Code"),
